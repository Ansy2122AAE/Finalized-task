...
function out = forces_moments(x, delta, wind, P)
    ...
    pForce = 0.5*P.rho*P.S_prop*P.C_prop*[(P.k_motor*delta_t)^2-Va^2;
                                                  0;
                                                  0];
    ...
    Torque = 0.5*P.rho*Va^2*P.S_wing*[P.b*(P.C_ell_0+(P.C_ell_beta*beta)+(P.C_ell_p*P.b/2/Va*p)+(P.C_ell_r*P.b/2/Va*r)+(P.C_ell_delta_a*delta_a)+(P.C_ell_r*delta_r));
                                      P.c*(P.C_m_0+(P.C_m_alpha*alpha)+(P.C_m_q*P.c/2/Va*q)+(P.C_m_delta_e*delta_e));
                                      P.b*(P.C_n_0+(P.C_n_beta*beta)+(P.C_n_p*P.b/2/Va*p)+(P.C_n_r*P.b/2/Va*r)+(P.C_n_delta_a*delta_a)+(P.C_n_r*delta_r))]+[-P.k_T_P*(P.k_Omega*delta_t)^2; 0; 0];
